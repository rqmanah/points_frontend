...
function UploadTeachersFile() {
  document.title = "رفع ملف المعلمين";
  ...
  const {
    ...
    mutationKey: ["school/manager/teachers/storeExcel"],
    endpoint: `school/manager/teachers/storeExcel`,
    onSuccess: (data) => {
  ...
  return (
    <div className="container-fluid">
      ...
      <SuccessModal
        ...
        // subText={`${ErrorRows?.map((item) => item)}`}
        children={
          <div
            className=""
            style={{
